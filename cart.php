								...
								<table class="table">
									...
									// while($fetch_cart = mysqli_fetch_assoc($select_cart)){	
										...
										<tr>
											...
											<td>
												<div class="input-group mb-3 d-flex align-items-center justify-self-center quantity-container" style="max-width: 120px;">
						...
						<div class="col-md-6">
							<div class="row mb-5 d-flex flex-column">
								<div class="col-md-6 mb-3 ">
									<a href="" class="btn btn-black btn-med btn-block">Update Cart</a>
                    			</div>
								<div class="col-md-6">
							...
							<div class="row justify-content-end">
								<div class="col-md-7">
									...
									<div class="row mb-5">
										...
										<strong class="text-black" >₹<?php total_cart_price() ?>/-</span></strong>
										</div>
									</div>
						
									<div class="row">
										<div class="col-md-12">										
										<a href="checkout.php" class="btn btn-black btn-lg py-3 btn-block <?php echo (total_cart_price() > 1)?'':'enabled'; ?>" >Proceed To Checkout</a>
										</div>
									</div>
								</div>
							</div>
