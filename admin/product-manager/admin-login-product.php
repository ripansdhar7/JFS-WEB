		...
		<div class="login box-content">
			<div class="input-box">
				<div class="login box-content-left">
					<h1>Welcome!</h1>
					<p>Product Manager Login Page</p>
...
if(isset($_POST['login'])){
   ...
   $select_users = mysqli_query($conn, "SELECT * FROM `admin_product` WHERE username = '$uname' AND password = '$pass'") or die('query failed');
   ...
   if(mysqli_num_rows($select_users) > 0){
      ...
      while ($row = mysqli_fetch_assoc($select_users)) {
         ...
         $_SESSION['admin_product_username'] = $row['username'];
         $_SESSION['admin_product_id'] = $row['id'];
         header('location:products-area.php');
